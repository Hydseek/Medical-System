...
class RendezVousCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            AssociationField::new('patient')
                ->setFormTypeOption('query_builder', function (\App\Repository\PatientRepository $repo) {
    ...
    public function persistEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        // Prevent creating appointments for administrator accounts
        $patient = $entityInstance->getPatient();
        if ($patient && in_array('ROLE_ADMIN', $patient->getRoles(), true)) {
            throw new AccessDeniedException('Cannot create an appointment for an administrator.');
        }
